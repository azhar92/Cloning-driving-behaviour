...
# Data augmentation for flipping image
    ...
    while 1:
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                ...
                measurements.extend([center_angle, center_flipped[1]])
                ...
                measurements.extend([left_angle, left_flipped[1]])
                ...
                measurements.extend([right_angle, right_flipped[1]])
...
#Implementation of NVIDIA End-to-End Deep learning. Using camera images and steering angles.
